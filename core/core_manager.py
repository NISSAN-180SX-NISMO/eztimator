...
from modules.interfaces.data_base_service_interface import DataBaseServiceInterface
...
class CoreManager:
    def __init__(self):
        ...
        self.data_base_service: DataBaseServiceInterface = DataBaseServiceInterface()
